...
\+\=                        { return new Symbol(sym.OPADDUNION, yytext());}
\-\=                        { return new Symbol(sym.OPRESTA, yytext());}
\*\=                        { return new Symbol(sym.OPINTER, yytext());}
\<\=\=                      { return new Symbol(sym.OPADD, yytext());}

\=\=\>                      { return new Symbol(sym.OPREMOVE, yytext());}
